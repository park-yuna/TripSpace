...
var BestInfo = [
    {
        ...
        tourDetail1 : "호주의 대표 도시, 시드니! 도시와 자연이 공존하는 매력적인 시드니에서 특별한 경험을 만끽하세요!",
        tourDetail2 : "천혜의 자연, 희귀동식물들의 천국! 진정한 호주를 느낄수있는 호바트와 시드니의 만남을 즐길 수 있는 기회!",
    ...
    },
    {
        ...
        tourDetail1 : "젯스타를 타고 떠나는 골드코스트 직항 상품입니다. 골드코스트 해변가에 위치한 파라다이스로 떠나자!",
        tourDetail2 : "최대 규모를 자랑하는 그랜드 브리오 리조트는 사이판의 중심 시내에 위치한 곳으로 최적의 입지를 자랑합니다!",
        tourDetail3 : "시드니와 골드코스트, 케언즈 호주의 동부해안을 둘러볼 수 있는 완벽한 여름 휴가 관광 상품입니다.",
        price1 : "3,752,000원~",
        price2 : "2,449,700원~",
        price3 : "2,604,000원~",
    },
    {
        ...
        tourDetail2 : "'지상낙원' 이라는 표현 밖에 떠오르지 않는 여행지인 바로 그 곳, 몰디브로 지금 당장 떠나보세요!",
        tourDetail3 : "하얏트 명성에 어울리는 여유롭고 한적한 휴가를 즐기고자 하시는 고객님께 강력 추천해드립니다.",
        price1 : "3,649,000원~",
        price2 : "4,999,700원~",
        price3 : "2,577,200원~",
    },
