...
var BestInfo = [
    {
        ...
        tourDetail1 : "후기로 인정 받은 인기 상품! 올드카 탑승 포함! 페루 쿠바 멕시코 3개국 짧은 일정으로 정복하기!",
        tourDetail2 : "미국의 심장 뉴욕과 근교 대표도시 워싱턴, 나이아가라를 한번에 볼 수 있는 관광 상품입니다.",
    ...
    },
    {
        ...
        tourDetail3 : "후기로 인정 받은 인기 상품! 세계3대폭포 나이아가라와 캐나다속 프랑스 퀘벡 완벽 관광 상품입니다.",
        price1 : "1,352,000원~",
        price2 : "7,449,700원~",
        price3 : "1,394,000원~",
    },
    {
        ...
        tourDetail1 : "Trip Space 미국 패키지 상품 중에서 고객님들께 가장 오래도록 사랑 받은 베스트셀러 상품입니다.",
        tourDetail2 : "페루/브라질/아르헨티나/칠레 4개국 엄선된 특급 호텔과 왕복 비즈니스 탑승으로 누리는 프리미엄 남미 여행!",
        tourDetail3 : "살고싶은도시 No.1 캐나다 밴쿠버 웰니스 라이프 체험하기! (1개월 교통패스 포함 가격입니다.)",
        price1 : "2,319,000원~",
        price2 : "11,999,700원~",
        price3 : "1,597,200원~",
    },
