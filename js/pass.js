...
var BestInfo = [
    {
        ...
        tourDetail2 : "런던 아이 우선 탑승권 with 샴페인 (Champagne Experience)",
        tourDetail3 : "NEW 파리 뮤지엄 패스 4일권(몽파르나스 타워 입장권 무료증정)",
        price1 : "53,900원~",
        price2 : "59,900원~",
        price3 : "78,400원~",
    },
    {
        ...
        tourTitle2 : "방콕",
        tourTitle3 : "보라카이",
        tourDetail1 : "유니버설 스튜디오 헐리우드 일반권 (1일권 가격으로 2일 방문가능)",
        tourDetail2 : "인스타 핫플 투어! 마하나콘 킹파워 타워 스카이워크로 가자!",
        tourDetail3 : "칼리보공항 BK 라운지 + 보딩서비스를 한번에 만나보세요!",
        price1 : "152,000원~",
        price2 : "89,700원~",
        price3 : "10,000원~",
    },
    {
        ...
        tourTitle2 : "세비야",
        tourTitle3 : "로마",
        tourDetail1 : "베니스 마르코폴로 공항 픽업or샌딩(이탈리아/베네치아) / 편도 상품입니다.",
        tourDetail2 : "신개념 자유여행! 조이버스로 즐기는 색다른 유럽!(이동편+AVE열차/숙박옵션)",
        tourDetail3 : "영화 속 명소로 떠나자! 친퀘테레(라 스페치아)/피사 1일 (이동편/숙박옵션)",
        price1 : "109,000원~",
        price2 : "299,700원~",
        price3 : "177,200원~",
    },
