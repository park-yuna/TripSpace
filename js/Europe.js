...
var BestInfo = [
    {
        ...
        tourTitle3 : "영국 완전일주",
        tourDetail1 : "전문가가 동행하여 조금 더 깊이있는 지식과 알찬 여행을 동시에 즐길 수 있는 상품입니다.",
        tourDetail2 : "서유럽 핵심국가(프랑스,스위스,이탈리아,영국)를 여행하는 알차고 저렴한 가성비 갑 상품!!",
    ...
    },
    {
        ...
        tourDetail2 : "꿈꾸던 나만의 북유럽 여행! 감성적이고 여유로운 북유럽 여행을 고객님께 강력 추천합니다!",
    ...
    },
    {
        ...
        tourDetail3 : "보다 특이한 지역의 자연 관광을 원하시는 분들을 위한 발칸반도를 중심으로 만들어진 상품입니다. ",
        price1 : "1,649,000원~",
        price2 : "2,999,700원~",
        price3 : "2,897,200원~",
    },
