...
var BestInfo = [
    ...
    },
    {
        ...
        tourDetail1 : "아프리카 최고의 사파리 세렝게티와 휴양 지상 낙원 잔지바르를 방문하는 절호의 기회! 놓치지 마세요.",
        tourDetail2 : "국적기를 이용한 두바이 & 아부다비를 완전정복 여행 할 수 있는 일주 5일 일정 상품입니다.",
        tourDetail3 : "북아프리카의 붉은 보석 모로코 까지 한번에 볼 수 있는 Trip Space의 베스트 셀러 상품입니다.",
        price1 : "3,752,000원~",
        price2 : "2,449,700원~",
        price3 : "2,604,000원~",
    },
    {
        ...
        tourDetail2 : "이집트 고대 역사 유물인 스핑크스, 피라미드와 두바이 여행까지 한번에 가능한 일정입니다.",
