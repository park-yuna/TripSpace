...
var BestInfo = [
    {
        ...
        tourDetail2 : "여유롭게 한나라만 즐길수 있는 이태리 완전일주 상품입니다. 보다 깊이있는 여행을 즐기세요.",
    ...
    },
    {
        ...
        tourDetail1 : "미국 서부와 동부를 한 번에 여행할 수 있는 Trip Space 베스트 투어 실속 패키지 상품입니다.",
        tourDetail2 : "일급 리조트로 여유를 더하고 저렴한 가격으로 실속있는 여행을 선호하는 분에게 추천하는 상품입니다.",
    ...
    },
    {
        ...
        tourDetail3 : "북유럽도 Trip Space 투어로 가면 특별하다!! 북유럽 베스트 상품이자 메인 상품입니다.",
        price1 : "4,830,000원~",
        price2 : "6,463,700원~",
        price3 : "5,327,200원~",
    },
